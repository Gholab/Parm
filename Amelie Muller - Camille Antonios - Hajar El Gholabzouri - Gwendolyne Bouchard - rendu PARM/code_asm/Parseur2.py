...
def cptReg(liste):
    # compte le nombre de registre dans les instructions dupliquées pour déterminer which decoupage to choose
    cpt = 0
        ...
        for line in input_file.readlines():
            ...
            if len(line) > 0:
                ...
                if line[0] == "." and line[-1] == ":":
                    labels[line[:-1]] = i
                if "run:" not in variable and "pop" not in variable and "push" not in variable and line[0] != "." and \
                        line[0] != "@":
                    i += 1
    return labels
